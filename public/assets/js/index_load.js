    ...
    function(configFile) {
        ...
        function initSpeechRecognition() {
            ...
            recognition.onstart = function() {
                ...
                start_img.src = BASE_ASSET + 'assets/img/mic-animate.gif';
            ...
            recognition.onend = function() {
                ...
                start_img.src = BASE_ASSET + 'assets/img/mic.gif';
                if (!final_transcript) {
                    showInfo('info_start');
                    return;
                }
        ...
        function startStopListening() {
            ...
            //start listening or stop listening if already listening
                ...
                recognition.start();
                ignore_onend = false;
                start_img.src = BASE_ASSET + 'assets/img/mic-slash.gif';
                showInfo('info_allow');
                showButtons('none');
        ...
        function addMarksToTable(pos, marks) {
            ...
            var top = lastAddedRow.documentOffsetTop() - (window.innerHeight / 2);
        ...
        function generateTableData(dataFromFile) {
            ...
            console.log(studentsNameFuzzySet);
        ...
        function addRowsToTable() {
            ...
            for (let i = 2; i < tabularFileData.length; i++) {
                const student_name = tabularFileData[i][0];
                const fuzzy_name = data2[i - 2];
                const student_grade = data3[i - 2] || '';
                ...
                const fuzzy_name_node = document.createTextNode(fuzzy_name);
        ...
        generateTableData(data1);
        generateFuzzyData(data2);
